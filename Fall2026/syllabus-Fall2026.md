...
- Instructor's office hours: Wed 11:00am-12:00pm, Fri 8:00am-9:00am, 2129 Engineering Building [Zoom option available](https://msu.zoom.us/j/92931714382) (Passcode: 903041)
...
- **Generative AI:** Generative AI may be used for learning the course materials. You may use it to further elaborate on the topics covered in class, finding more examples, etc. If you use it to generate answers for your homework, make sure you fully understand the solution provided as these systems have been known to hallucinate and can provide the wrong answer. In addition, if you do not fully understand how to solve the problem and rely only the the system, you may encounter difficulties during exams.  
- **Resources for Students:** Michigan State University is committed to providing access and inclusion in all programs, services and activities. Disabled persons should contact the Resource Center for Persons with Disabilities at 517-884-RCPD or by visiting [RCPD’s website](https://uhw.msu.edu/health-and-wellbeing-services/accessibility-and-accommodations/rcpd/get-started) to request accommodations. Additional communication between the student, instructor, and RCPD specialist may be necessary to ensure an accessible classroom experience. Please send your Accommodation Letter to me as soon as possible so I can ensure proper facilitation of accommodations. Accommodation Letters are generated and sent from within the AccessMSU student portal. Accommodations are not required to be provided prior to me receiving the letter. Students affiliated with RCPD prior to June 1, 2026 may have existing Accommodation Letters that were previously sent via email communication with instructors. I can still accept these letters, but you will need to also send your Accommodation Letter via [AccessMSU](https://uhw.msu.edu/health-and-wellbeing-services/accessibility-and-accommodations/rcpd/accessmsu).
